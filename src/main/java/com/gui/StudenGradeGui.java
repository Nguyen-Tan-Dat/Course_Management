...
public class StudenGradeGui extends UIPanel {
    ...
    private void initComponents()  {
        ...
        jPanel3 = new JPanel();
        jLabel1 = new JLabel();
        txt_idPreson = new JTextField();
        jLabel2 = new JLabel();
        txt_name = new JTextField();
        jLabel3 = new JLabel();
        txt_Grade = new JTextField();
        jLabel4 = new JLabel();
        txt_idCourse = new JTextField();
        jLabel5 = new JLabel();
        txt_NameCourse = new JTextField();
        jLabel6 = new JLabel();
        btn_delete = new JButton();
        btn_add1 = new JButton();
        btn_search = new JButton();
        jComboBoxStatus = new JComboBox<>();
        btn_reset = new JButton();
        btn_edit = new JButton();
        jScrollPane1 = new JScrollPane();
        jTable_Preson = new JTable();
        jScrollPane2 = new JScrollPane();
        jTable_Course = new JTable();
        jLabel7 = new JLabel();
        jLabel8 = new JLabel();
        jLabel9 = new JLabel();
        ...
        jComboBoxStatus.setModel(new DefaultComboBoxModel<>(new String[] { "All", "Online", "OnSite" }));
                ...
                jPanel3Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel3Layout.createSequentialGroup()
                                                .addGroup(jPanel3Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                        .addComponent(txt_idPreson, GroupLayout.PREFERRED_SIZE, 85, GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(txt_name, GroupLayout.PREFERRED_SIZE, 164, GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(txt_Grade, GroupLayout.PREFERRED_SIZE, 85, GroupLayout.PREFERRED_SIZE))
                                                ...
                                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                                .addGroup(jPanel3Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                        .addComponent(txt_idCourse, GroupLayout.PREFERRED_SIZE, 85, GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(txt_NameCourse, GroupLayout.PREFERRED_SIZE, 144, GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(jComboBoxStatus, GroupLayout.PREFERRED_SIZE, 84, GroupLayout.PREFERRED_SIZE)))
                                        .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                jPanel3Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                        ...
                                        .addComponent(txt_idPreson, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jLabel4)
                                        .addComponent(txt_idCourse, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel3Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                        .addComponent(txt_NameCourse, GroupLayout.PREFERRED_SIZE, 22, GroupLayout.PREFERRED_SIZE)
                                        .addGroup(jPanel3Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                        ...
                                        .addComponent(txt_Grade, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jLabel6)
                                        .addComponent(jComboBoxStatus, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                                .addGap(29, 29, 29)
                                .addGroup(jPanel3Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                        .addComponent(btn_add1)
                                        .addComponent(btn_delete)
        ...
        jTable_Preson.setModel(new DefaultTableModel(
                new Object [][] {
        ...
        jTable_Course.setModel(new DefaultTableModel(
                new Object [][] {
...
// </editor-fold>//GEN-END:initComponents
    ...
    private JTable jTable_Preson;
    private JTextField txt_Grade;
    private JTextField txt_NameCourse;
    private JTextField txt_idCourse;
    private JTextField txt_idPreson;
